...
{
    public class CombatAttributeTemplateViewModel : DungeonObjectTemplateViewModel
    {
        ...
        public CombatAttributeTemplateViewModel()
        {
            this.Attack = new RangeViewModel<double>(0, 0, 0, 1000);
            this.Resistance = new RangeViewModel<double>(0, 0, 0, 1000);
        }
    }
}
