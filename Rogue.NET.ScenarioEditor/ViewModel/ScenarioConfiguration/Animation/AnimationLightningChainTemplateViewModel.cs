...
{
    [UIType(DisplayName = "Lightning Chain Animation",
            Description = "Animation type that creates a wandering lightning bolt through the affected Characters",
            ViewType = typeof(AnimationLightningChainParameters),
            BaseType = UITypeAttributeBaseType.Animation)]
    public class AnimationLightningChainTemplateViewModel : AnimationBaseTemplateViewModel
    {
        ...
        public AnimationLightningChainTemplateViewModel()
        {
