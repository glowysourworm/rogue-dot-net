...
namespace Rogue.NET.ScenarioEditor.Views.Assets.SharedControl.AlterationControl.EffectControl
{
    ...
    [Export]
    public partial class DetectEffectParameters : UserControl
    {
        [ImportingConstructor]
        public DetectEffectParameters(IRogueEventAggregator eventAggregator, IScenarioCollectionProvider scenarioCollectionProvider)
        {
            InitializeComponent();
