...
namespace Rogue.NET.Model.Media
{
    ...
    {
        public static AnimationGroup CreateAnimation(AnimationTemplate t,Rect bounds, Point pPlayer, Point[] pEnemy)
        {
            switch (t.Type)
            {
                case AnimationType.AuraTarget:
                    return AnimationGenerator.CreateAuraModulation(pEnemy[0], t.StrokeTemplate.GenerateBrush(),
                ...
                case AnimationType.AuraSelf:
                    return AnimationGenerator.CreateAuraModulation(pPlayer, t.StrokeTemplate.GenerateBrush(),
                        t.FillTemplate.GenerateBrush(), t.StrokeThickness, t.Opacity1, t.Opacity2, new Size(t.Width1, t.Height1),
                        new Size(t.Width2, t.Height2), t.AnimationTime, t.RepeatCount, t.AutoReverse);
                case AnimationType.BarrageTarget:
                    return AnimationGenerator.CreateEllipseBarrage(t.ChildCount, pEnemy[0], t.RadiusFromFocus, t.StrokeTemplate.GenerateBrush(),
                        t.FillTemplate.GenerateBrush(), t.StrokeThickness, t.Opacity1, t.Opacity2, new Size(t.Width1, t.Height1), 
                ...
                case AnimationType.BarrageSelf:
                    return AnimationGenerator.CreateEllipseBarrage(t.ChildCount, pPlayer, t.RadiusFromFocus, t.StrokeTemplate.GenerateBrush(),
                        t.FillTemplate.GenerateBrush(), t.StrokeThickness, t.Opacity1, t.Opacity2, new Size(t.Width1, t.Height1),
                ...
                case AnimationType.BubblesTarget:
                    return AnimationGenerator.CreateBubbles(t.ChildCount, pEnemy[0], t.RadiusFromFocus, t.StrokeTemplate.GenerateBrush(), t.FillTemplate.GenerateBrush(),
                ...
                case AnimationType.BubblesSelf:
                    return AnimationGenerator.CreateBubbles(t.ChildCount, pPlayer, t.RadiusFromFocus, t.StrokeTemplate.GenerateBrush(), t.FillTemplate.GenerateBrush(),
                         t.StrokeThickness, t.Opacity1, t.Opacity2, new Size(t.Width1, t.Height1),
                        new Size(t.Width2, t.Height2), t.RoamRadius, t.Erradicity, t.AnimationTime, t.RepeatCount);
                case AnimationType.BubblesScreen:
                    return AnimationGenerator.CreateBubbles(t.ChildCount, bounds, t.StrokeTemplate.GenerateBrush(), t.FillTemplate.GenerateBrush(),
                            t.StrokeThickness, t.Opacity1, t.Opacity2, new Size(t.Width1, t.Height1),
                ...
                case AnimationType.ChainSelfToTargetsInRange:
                    {
                        ...
                        return new AnimationGroup(new Animation[]{AnimationGenerator.GenerateProjectilePath(list.ToArray()
                ...
                case AnimationType.ProjectileTargetsInRangeToSelf:
                    {
                        ...
                        {
                            Animation a = AnimationGenerator.GenerateProjectilePath(new Point[]{ep, pPlayer}
                                , new Size(t.Width1, t.Height1)
                                , new Size(t.Width2, t.Height2)
                                , t.StrokeTemplate.GenerateBrush()
                                , t.FillTemplate.GenerateBrush()
                ...
                case AnimationType.ProjectileTargetToSelf:
                    return AnimationGenerator.CreateEllipseProjectile(pEnemy[0], pPlayer, t.StrokeTemplate.GenerateBrush(), t.FillTemplate.GenerateBrush(),
                        t.StrokeThickness, t.Opacity1, t.Opacity2, new Size(t.Width1, t.Height1),
                        new Size(t.Width2, t.Height2),
                ...
                case AnimationType.ProjectileSelfToTargetsInRange:
                    {
                        ...
                        foreach (Point ep in pEnemy)
                        {
                            Animation a = AnimationGenerator.GenerateProjectilePath(new Point[] { pPlayer, ep }
                                , new Size(t.Width1, t.Height1)
                                , new Size(t.Width2, t.Height2)
                                , t.StrokeTemplate.GenerateBrush()
                                , t.FillTemplate.GenerateBrush()
                ...
                case AnimationType.ProjectileSelfToTarget:
                    return AnimationGenerator.CreateEllipseProjectile(pPlayer, pEnemy[0], t.StrokeTemplate.GenerateBrush(), t.FillTemplate.GenerateBrush(),
                        t.StrokeThickness, t.Opacity1, t.Opacity2, new Size(t.Width1, t.Height1),
                        new Size(t.Width2, t.Height2),
                        t.AccelerationRatio, t.Erradicity, t.AnimationTime, t.Velocity, t.RepeatCount, t.AutoReverse, t.ConstantVelocity);
                ...
                case AnimationType.SpiralTarget:
                    return AnimationGenerator.CreateEllipseSpiral(t.ChildCount, pEnemy[0], t.RadiusFromFocus, t.SpiralRate, t.StrokeTemplate.GenerateBrush(),
                        t.FillTemplate.GenerateBrush(), t.StrokeThickness, t.Opacity1, t.Opacity2, new Size(t.Width1, t.Height1),
                        new Size(t.Width2, t.Height2),t.AccelerationRatio, t.Erradicity,
                        t.AnimationTime, t.RepeatCount, t.AutoReverse);
                case AnimationType.SpiralSelf:
                    return AnimationGenerator.CreateEllipseSpiral(t.ChildCount, pPlayer, t.RadiusFromFocus, t.SpiralRate, t.StrokeTemplate.GenerateBrush(),
                        t.FillTemplate.GenerateBrush(), t.StrokeThickness, t.Opacity1, t.Opacity2, new Size(t.Width1, t.Height1),
                        new Size(t.Width2, t.Height2), t.AccelerationRatio, t.Erradicity,
                        t.AnimationTime, t.RepeatCount, t.AutoReverse);
            }
        ...
        public static AnimationGroup CreateEllipseProjectile(Point p1, Point p2, Brush stroke, Brush fill, 
        ...
        public static AnimationGroup CreateEllipseBarrage(int count, Point focus, double radiusFromFocus, Brush stroke, 
        ...
        public static AnimationGroup CreateEllipseSpiral(int count, Point focus, double radius, double spiralRate, 
        ...
        public static AnimationGroup CreateAuraModulation(Point p, Brush stroke, Brush fill, double strokeThickness, double opacity1, double opacity2, Size s1, Size s2, int time, int repeatCount, bool autoreverse)
        {
            Animation a = GenerateAuraAnimation(p, s1, s2,stroke, fill, opacity1, opacity2,  strokeThickness, 0, 1, time, repeatCount, autoreverse);
            return new AnimationGroup(new Animation[] { a });
        }
        public static AnimationGroup CreateBubbles(int count, Rect rect, Brush stroke, Brush fill, double strokeThickness, double opacity1, double opacity2, Size s1, Size s2, double roamRadius, int erradicity, int time, int repeatCount)
        {
        ...
        public static AnimationGroup CreateBubbles(int count, Point focus, double radiusFromFocus, Brush stroke, Brush fill, double strokeThickness, double opacity1, double opacity2, Size s1, Size s2, double roamRadius, int erradicity, int time, int repeatCount)
        {
            Random r = new Random(13322);
            List<Animation> list = new List<Animation>();
            for (int i = 0; i < count; i++)
        ...
        public static AnimationGroup CreateFadingChain(Point[] pts, Brush stroke, double strokeThickness,double opacity1, double opacity2, int erradicity, int time, int repeatCount, bool autoreverse)
        {
            List<Animation> list = new List<Animation>();
        ...
        public static Animation GenerateTimedFigure(Geometry g, Brush stroke, Brush fill, double strokethickness, double opacity1, double opacity2, int erradicity, int time, int repeatCount, bool autoreverse)
        {
        ...
        public static Animation GenerateProjectilePath(Point[] pts, Size s1, Size s2, Brush stroke, Brush fill, double opacity1, double opacity2, double strokeThickness, double accelerationRatio, int erradicity, int time, int velocity, int repeatCount, bool autoreverse, bool constVelocity)
        {
        ...
        public static Animation GenerateAuraAnimation(Point pt, Size s1, Size s2, Brush stroke, Brush fill, double opacity1, double opacity2, double strokeThickness, double accelerationRatio, int erradicity, int time, int repeatCount, bool autoreverse)
        {
            //Generate Animations
            Duration d = new Duration(new TimeSpan(0, 0, 0, 0, (int)time));
            Duration dErr = (erradicity > 0) ? new Duration(new TimeSpan(0, 0, 0, 0, (int)(time / (double)erradicity))) : d;
