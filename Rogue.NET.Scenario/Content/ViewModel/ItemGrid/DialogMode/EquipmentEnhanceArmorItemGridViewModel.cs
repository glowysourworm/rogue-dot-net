...
namespace Rogue.NET.Scenario.Content.ViewModel.ItemGrid.DialogMode
{
    ...
    [Export]
    public class EquipmentEnhanceArmorItemGridViewModel : EquipmentItemGridViewModelBase
    {
        [ImportingConstructor]
        public EquipmentEnhanceArmorItemGridViewModel(
