...
namespace Rogue.NET.Scenario.Content.ViewModel.ItemGrid.DialogMode
{
    ...
    [Export]
    public class EquipmentImbueArmorItemGridViewModel : EquipmentItemGridViewModelBase
    {
        [ImportingConstructor]
        public EquipmentImbueArmorItemGridViewModel(
        ...
        {
            return item.IsArmorType() && item.CanImbue();
        }
    }
}
