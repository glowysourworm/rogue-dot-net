...
namespace Rogue.NET.Scenario.Content.ViewModel.ItemGrid.DialogMode
{
    ...
    [Export]
    public class EquipmentImbueWeaponItemGridViewModel : EquipmentItemGridViewModelBase
    {
        [ImportingConstructor]
        public EquipmentImbueWeaponItemGridViewModel(
