...
namespace Rogue.NET.Core.Model.ScenarioConfiguration.Alteration.Enemy
{
    [Serializable]
    public class EnemyAlterationTemplate : Template
    {
        ...
        public IEnemyAlterationEffectTemplate Effect
        {
            get { return _effect; }
            set
            {
        ...
        public EnemyAlterationTemplate()
        {
