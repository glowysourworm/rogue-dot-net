...
namespace Rogue.NET.Core.Processing.Model.Content.Interface
{
    ...
    public interface IAlterationProcessor
    {
        ...
        /// </summary>
        bool Validate(CharacterBase actor, AlterationContainer alteration);
        ...
        /// </summary>
        void Queue(CharacterBase actor, AlterationContainer alteration);
        ...
        /// </summary>
        void Queue(CharacterBase actor, IEnumerable<CharacterBase> affectedCharacters, AlterationContainer alteration);
        ...
        /// </summary>
        void Process(CharacterBase actor, IEnumerable<CharacterBase> affectedCharacters, AlterationContainer alteration);
