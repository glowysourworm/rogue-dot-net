    ...
    public partial class SpinPanel : Panel
    {
        ...
        public void InitializeElements()
        {
            ...
            for (int i = 0; i < this.VisualChildrenCount; i++)
            {
                ...
                LinearDoubleKeyFrame e0 = new LinearDoubleKeyFrame(0.4, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds(0)));
                ...
                LinearDoubleKeyFrame e2 = new LinearDoubleKeyFrame(0.4, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds(_TOTAL_MILLISEC / 2)));
                LinearDoubleKeyFrame e3 = new LinearDoubleKeyFrame(0.1, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds((_TOTAL_MILLISEC * 3) / 4)));
                LinearDoubleKeyFrame e4 = new LinearDoubleKeyFrame(0.4, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds(_TOTAL_MILLISEC)));
                ...
                LinearDoubleKeyFrame x0 = new LinearDoubleKeyFrame(.5, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds(0)));
                ...
                LinearDoubleKeyFrame x2 = new LinearDoubleKeyFrame(.5, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds(_TOTAL_MILLISEC / 2)));
                LinearDoubleKeyFrame x3 = new LinearDoubleKeyFrame(.25, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds((_TOTAL_MILLISEC * 3) / 4)));
                LinearDoubleKeyFrame x4 = new LinearDoubleKeyFrame(.5, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds(_TOTAL_MILLISEC)));
                ...
                LinearDoubleKeyFrame y0 = new LinearDoubleKeyFrame(.5, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds(0)));
                ...
                LinearDoubleKeyFrame y2 = new LinearDoubleKeyFrame(.5, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds(_TOTAL_MILLISEC / 2)));
                LinearDoubleKeyFrame y3 = new LinearDoubleKeyFrame(.25, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds((_TOTAL_MILLISEC * 3) / 4)));
                LinearDoubleKeyFrame y4 = new LinearDoubleKeyFrame(.5, KeyTime.FromTimeSpan(TimeSpan.FromMilliseconds(_TOTAL_MILLISEC)));
